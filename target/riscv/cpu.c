...
static Property riscv_cpu_extensions[] = {
    ...
    DEFINE_PROP_BOOL("smcsrind", RISCVCPU, cfg.ext_smcsrind, false),
    DEFINE_PROP_BOOL("sscsrind", RISCVCPU, cfg.ext_sscsrind, false),
    DEFINE_PROP_BOOL("smcdeleg", RISCVCPU, cfg.ext_smcdeleg, false),
    DEFINE_PROP_BOOL("ssccfg", RISCVCPU, cfg.ext_ssccfg, false),
    ...
    DEFINE_PROP_BOOL("x-smctr", RISCVCPU, cfg.ext_smctr, false),
    DEFINE_PROP_BOOL("x-ssctr", RISCVCPU, cfg.ext_ssctr, false),
