...
#define MCTRCTL_MASK (MCTRCTL_M_ENABLE | MCTRCTL_S_ENABLE |       \
                          ...
                          MCTRCTL_TKBRINH |            \
                          MCTRCTL_INDCALL_INH | MCTRCTL_DIRCALL_INH | \
                          MCTRCTL_INDJUMP_INH | MCTRCTL_DIRJUMP_INH | \
                          MCTRCTL_CORSWAP_INH | MCTRCTL_RET_INH |     \
                          MCTRCTL_INDOJUMP_INH | MCTRCTL_DIROJUMP_INH)
...
#define SCTRCTL_MASK (SCTRCTL_S_ENABLE | SCTRCTL_U_ENABLE |       \
                          ...
                          SCTRCTL_TKBRINH |            \
                          SCTRCTL_INDCALL_INH | SCTRCTL_DIRCALL_INH | \
                          SCTRCTL_INDJUMP_INH | SCTRCTL_DIRJUMP_INH | \
                          SCTRCTL_CORSWAP_INH | SCTRCTL_RET_INH |     \
                          SCTRCTL_INDOJUMP_INH | SCTRCTL_DIROJUMP_INH)
...
#define VSCTRCTL_MASK (VSCTRCTL_VS_ENABLE | VSCTRCTL_VU_ENABLE | \
                       ...
                       VSCTRCTL_LCOFIFRZ |                               \
                       VSCTRCTL_EXCINH |       \
                       VSCTRCTL_INTRINH | VSCTRCTL_TRETINH |         \
                       VSCTRCTL_NTBREN  | VSCTRCTL_TKBRINH |         \
                       VSCTRCTL_INDCALL_INH |        \
